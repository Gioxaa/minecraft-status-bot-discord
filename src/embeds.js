...
// Embed Message for vote commands
const voteEmbed = new EmbedBuilder()
  ...
  .setTitle(embedReadData.vote.title.replace(/\{vote\}/gi, mcserver.vote))
  .setDescription(embedReadData.vote.description.replace(/\{vote\}/gi, mcserver.vote))
